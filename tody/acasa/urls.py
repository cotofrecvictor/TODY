...
from .views import CreazaSarcina, DetaliiSarcina, ListaSarcini,EditeazaSarcina, StergeSarcina, LogareView, PaginaInregistrare
from django.contrib.auth.views import LogoutView
urlpatterns = [
    path('login/', LogareView.as_view(), name = 'login'),
    path('logout/', LogoutView.as_view(next_page='login'), name = 'logout'),
    path('inregistrare/', PaginaInregistrare.as_view(), name ='inregistrare'),
